 ...
 *
 * This file mirrors `backend/overlay/contract.go` exactly. Every string used in
 ...
 *
 * If a value changes in `backend/overlay/contract.go`, it MUST change here in
...
// Source: backend/overlay/contract.go OverlayData JSON tags
// ---------------------------------------------------------------------------
...
// Source: backend/overlay/contract.go ApplyDataOverrides switch cases
...
// Source: backend/service/overlay.go GetOrCreateConfig default map
// ---------------------------------------------------------------------------
...
// Source: backend/overlay/contract.go line 130 comment
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Source Profile enums (backend/handler/source_profile.go validation)
// ---------------------------------------------------------------------------
...
// Source: backend/service/overlay.go BroadcastOverlayData + broadcastConfigChange
// ---------------------------------------------------------------------------
